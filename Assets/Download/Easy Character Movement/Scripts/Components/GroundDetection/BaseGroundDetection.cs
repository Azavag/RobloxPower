...
namespace ECM.Components
{
    ...
    public abstract class BaseGroundDetection : MonoBehaviour
    {
        ...
        /// <summary>
        /// InitializeIcon overlap mask, this uses the rigidbody's layer's collision matrix.
        /// </summary>
        ...
        /// </summary>
        /// <param skinName="position">The probing position.</param>
        /// <param skinName="rotation">The probing rotation.</param>
        /// <param skinName="overlapCount">The amount of entries written to the buffer.</param>
        ...
        /// </summary>
        /// <param skinName="origin">The starting point of the ray in world coordinates.</param>
        /// <param skinName="direction">The direction of the ray.</param>
        /// <param skinName="hitInfo">If true is returned, hitInfo will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The length of the cast.</param>
        /// <param skinName="backstepDistance">Probing backstep distance to avoid initial overlaps.</param>
        ...
        /// </summary>
        /// <param skinName="origin">The center of the sphere at the start of the sweep.</param>
        /// <param skinName="radius">The radius of the sphere.</param>
        /// <param skinName="direction">The direction into which to sweep the sphere.</param>
        /// <param skinName="hitInfo">If true is returned, hitInfo will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The length of the cast.</param>
        /// <param skinName="backstepDistance">Probing backstep distance to avoid initial overlaps.</param>
        /// <returns>True when the intersects any 'ground' collider, otherwise false.</returns>
        ...
        /// </summary>
        /// <param skinName="bottom">The center of the sphere at the start of the capsule.</param>
        /// <param skinName="top">The center of the sphere at the end of the capsule.</param>
        /// <param skinName="radius">The radius of the sphere.</param>
        /// <param skinName="direction">The direction into which to sweep the sphere.</param>
        /// <param skinName="hitInfo">If true is returned, hitInfo will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The length of the cast.</param>
        ...
        /// </summary>
        /// <param skinName="position">Character's position, this can be different from character's current rotation.</param>
        /// <param skinName="rotation">Character's rotation, this can be different from character's current rotation.</param>
        /// <param skinName="direction">The direction into which to sweep the character's collider.</param>
        /// <param skinName="hitInfo">If true is returned, hitInfo will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The max length of the sweep.</param>
        /// <param skinName="backstepDistance">Probing backstep distance to avoid initial overlaps.</param>
        ...
        /// </summary>
        /// <param skinName="position">A probing position. This can be different from character's position.</param>
        /// <param skinName="rotation">A probing rotation. This can be different from character's rotation.</param>
        /// <param skinName="groundHitInfo">If true is returned, will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The length of the cast.</param>
        ...
        /// Returns true when intersects any 'ground' collider, otherwise false.
        /// </summary>
        /// <param skinName="direction">The direction into which to sweep.</param>
        /// <param skinName="hitInfo">If true is returned, hitInfo will contain more information about where the collider was hit.</param>
        /// <param skinName="distance">The length of the sweep.</param>
        /// <param skinName="backstepDistance">Probing backstep distance to avoid initial overlaps.</param>
