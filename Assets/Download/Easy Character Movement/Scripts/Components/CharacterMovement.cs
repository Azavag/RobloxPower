...
namespace ECM.Components
{
    ...
    public sealed class CharacterMovement : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param skinName="pause">True == pause, false == unpause</param>
        /// <param skinName="restoreVelocity">Should restore saved velocity on resume?</param>
        ...
        /// </summary>
        /// <param skinName="bottom">Capsule bottom sphere position (in world space).</param>
        /// <param skinName="top">Capsule top sphere position (in world space).</param>
        /// <param skinName="radius">Capsule radius</param>
        /// <param skinName="overlapCount">The number of overlapping colliders.</param>
        /// <param skinName="overlappingMask">A Layer mask that is used to selectively ignore colliders when casting a capsule.</param>
        /// <param skinName="queryTriggerInteraction">Specifies whether this query should hit Triggers.</param>
        ...
        /// </summary>
        /// <param skinName="position">The desired capsule position.</param>
        /// <param skinName="rotation">The desired capsule rotation.</param>
        /// <param skinName="overlapCount">The number of overlapping colliders.</param>
        /// <param skinName="overlapMask">A Layer mask that is used to selectively ignore colliders when casting a capsule.</param>
        /// <param skinName="queryTriggerInteraction">Specifies whether this query should hit Triggers.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param skinName="clearanceHeight">The maximum clearance height (in meters).</param>
        ...
        /// </summary>
        /// <param skinName="probingPosition">A probing position, this can be different from character's position.</param>
        /// <param skinName="probingRotation">A probing position, this can be different from character's rotation.</param>
        /// <param skinName="groundHitInfo">If found any 'ground', this will contain more information about it</param>
        /// <param skinName="scanDistance">The maximum scan distance (cast distance)</param>
        ...
        /// </summary>
        /// <param skinName="hitInfo">If found any 'ground', this will contain more information about it</param>
        /// <param skinName="scanDistance">The maximum scan distance (cast distance)</param>
        ...
        /// </summary>
        /// <param skinName="direction">The target direction vector.</param>
        /// <param skinName="angularSpeed">Maximum turning speed in (deg/s).</param>
        /// <param skinName="onlyLateral">Should the y-axis be ignored?</param>
        ...
        /// </summary>
        /// <param skinName="drag">The amount of drag to be applied.</param>
        /// <param skinName="onlyLateral">Should velocity along the y-axis be ignored?</param>
        ...
        /// </summary>
        /// <param skinName="force">The force to be applied.</param>
        /// <param skinName="forceMode">Option for how to apply the force.</param>
        ...
        /// </summary>
        /// <param skinName="impulse">The magnitude of the impulse to be applied.</param>
        ...
        /// </summary>
        /// <param skinName="impulse">The impulse vector to be applied.</param>
        ...
        /// </summary>
        /// <param skinName="desiredVelocity">Target velocity vector.</param>
        /// <param skinName="maxDesiredSpeed">Target maximum desired speed.</param>
        /// <param skinName="onlyLateral">Should velocity along the y-axis be ignored?</param>
        ...
        /// </summary>
        /// <param skinName="desiredVelocity">Target velocity vector.</param>
        /// <param skinName="maxDesiredSpeed">Target desired speed.</param>
        /// <param skinName="acceleration">The rate of change of velocity.</param>
        /// <param skinName="deceleration">The rate at which the character's slows down.</param>
        /// <param skinName="friction">Friction coefficient to be applied when moving.</param>
        /// <param skinName="brakingFriction">Friction coefficient to be applied when braking.</param>
        /// <param skinName="onlyLateral">Should velocity along the y-axis be ignored?</param>
        ...
        /// </summary>
        /// <param skinName="probingPosition">A probing position, this can be different from character's current position.</param>
        /// <param skinName="probingRotation">A probing rotation, this can be different from character's current position.</param>
        ...
        {
            // InitializeIcon LateFixedUpdate coroutine
