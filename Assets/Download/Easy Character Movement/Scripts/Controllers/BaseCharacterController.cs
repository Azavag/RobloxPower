...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        {
            get { return _isBlockInput; }
            set { _isBlockInput = value; }
        }
        ...
        {
            get { return _blockJump; }
            set { _blockJump = value; }
        }
        /// <summary>
        ...
        public bool jump
        {
            ...
            set
            {
                ...
                // Update jump value; if pressed, update held down breakTimer
                _jump = value;
                if (_jump)
        ...
        /// </summary>
        /// <param skinName="direction">The target direction</param>
        /// <param skinName="onlyLateral">Should it be restricted to XZ only?</param>
        ...
        public virtual void Jump()
        {
            ...
            if (blockJump)
                return;
            // Update jump ungrounded breakTimer (post jump tolerance time)
