...
namespace ECM.Helpers
{
    ...
    /// OrientModelToGround.
    /// 
    /// Helper component used to orient a enemyModel to ground.
    ...
    public sealed class OrientModelToGround : MonoBehaviour
    {
        ...
        [Tooltip("Should the enemyModel follow the ground slope?")]
        [SerializeField]
        private bool _orientToGround = true;

        [Tooltip("The enemyModel's transform to orient.")]
